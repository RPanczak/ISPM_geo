...
gem_21 <- st_read("data-raw/BfS/ag-b-00.03-875-gg21/ggg_2021-LV95/shp/g1g21_18042021.shp") %>%
...
lake_21 <- st_read("data-raw/BfS/ag-b-00.03-875-gg21/ggg_2021-LV95/shp/g1s21.shp") %>%
  select(GMDNR, GMDNAME)
...
canton_21 <- st_read("data-raw/BfS/ag-b-00.03-875-gg20/ggg_2020-LV95/shp/g1k20.shp") %>%
  select(KTNR, KTNAME)
